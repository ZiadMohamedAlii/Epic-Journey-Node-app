...
})({"inYZp":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "916932b22e4085ab";
module.bundle.HMR_BUNDLE_ID = "5c58a95fd0564005";
"use strict";
...
const updateData = async (name, email)=>{
    try {
        ...
        if (res.data.status === "success") (0, _alerts.showAlert)("success", "Data Updated");
    } catch (err) {
        (0, _alerts.showAlert)("error", err.response.data.message);
    }
};

},{"./alerts":"jIq27","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}]},["inYZp","lT62u"], "lT62u", "parcelRequire11c7")
